...
const (
	Messages_GetMessage_FullMethodName = "/proto.Messages/GetMessage"
)
...
func (c *messagesClient) GetMessage(ctx context.Context, in *GetMessageReq, opts ...grpc.CallOption) (*GetMessageReply, error) {
...
func (UnimplementedMessagesServer) GetMessage(context.Context, *GetMessageReq) (*GetMessageReply, error) {
...
func _Messages_GetMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessagesServer).GetMessage(ctx, req.(*GetMessageReq))
	}
